...
直径30mmまたは40mmの円形トラックパッドを配置できます。[サンプル](../sample/17key-col-staggered-trackpad-glp3.json)
...
モジュール配置パネルでトラックパッドを選択するとモジュール設定パネルからバリエーションを切り替えられます。現時点では直径30mm/40mmのトラックパッドに対応しています。
